...
<template>
  <div class="comment-container vp-raw">
    ...
    <!-- 备用 -->
    <!-- <component :is="'script'" src="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/2.1.8/lightgallery.min.js" integrity="sha384-l5lFB9srHFAyvfCoHya9X1JwGGTNPvDtikieqZp7qu/bomCw0e0+yoyiL0f7UXLD" crossorigin="anonymous"></component> -->
    ...
    <!-- 换tx源提高加载速度 -->
    <component :is="'script'" src="https://registry.npmmirror.com/twikoo/1.6.36/files/dist/twikoo.min.js" integrity="sha384-ocJyLUeo5I91x224iE/ke7PPHyXVSUKNL7GfqnEto/HxGuBLnLLlitt3dFT/Zwrn" crossorigin="anonymous" ref="twikooJs"></component>
